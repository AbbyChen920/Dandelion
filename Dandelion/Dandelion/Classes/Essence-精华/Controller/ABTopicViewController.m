...
//    
//    if ([NSStringFromClass(self.class) isEqualToString:@"ABAllViewController"]) {
//        params[@"type"] = @"1";
//    }else if ([NSStringFromClass(self.class) isEqualToString:@"ABVideoViewController"]) {
//        params[@"type"] = @"41";
//    }else if ([NSStringFromClass(self.class) isEqualToString:@"ABVoiceViewController"]) {
//        params[@"type"] = @"31";
//    }else if ([NSStringFromClass(self.class) isEqualToString:@"ABPictureViewController"]) {
//        params[@"type"] = @"10";
//    }else if ([NSStringFromClass(self.class) isEqualToString:@"ABWordViewController"]) {
//        params[@"type"] = @"29";
//    }
